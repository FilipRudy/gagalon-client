        ...
        <div className="contact-info-wrapper">
            <div className="contact-info-container">
                ...
                <div className="contact-info-card">
                    <h1 className="font-bolded">Kontakt ze sklepami</h1>
                ...
                <div className="contact-info-card">
                    <h1 className="font-bolded">Dane firmy</h1>
                    <p className="font-unbolded"><strong>"Gagalon" Spółka Jawna</strong></p>
                    <p className="font-unbolded"><strong>Bogumiła Wicherek, Zbigniew Wicherek</strong></p>
                    <p className="font-unbolded"><strong>40-190 Mikołów, ul. Słoneczna 41</strong></p>
                    <p className="font-unbolded"><strong>NIP: 6351006362</strong></p>
                    <h1 className="font-bolded">Dane kontaktowe</h1>
                    <p className="font-unbolded">
